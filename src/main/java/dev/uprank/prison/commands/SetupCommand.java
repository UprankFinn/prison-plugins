...
public class SetupCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String label, String[] args) {
        ...
        MineEntity mine = new MineEntity(args[0], new MineEntity.Location(
        ...
        ), Material.valueOf(args[1].toUpperCase()), new HashMap<>(), materials, new MineEntity.Cuboid(minimumPoint.getBlockX(), maximumPoint.getBlockX(), minimumPoint.getBlockY(), maximumPoint.getBlockY(), minimumPoint.getBlockZ(), maximumPoint.getBlockZ()));

        this.plugin.getMineEntityManager().registerMine(mine);
        this.plugin.getMineEntityManager().getMine(args[0]).setVolume();
